...
const MOCK_COLLECTIONS = [
  { id: "jar-1", title: "Chocolate Heaven", recipeCount: 14, coverImages: ["https://images.unsplash.com/photo-1499636136210-6f4ee915583e?w=600", "https://images.unsplash.com/photo-1617996884841-3949eaec3448?w=600", "https://images.unsplash.com/photo-1506224772180-d75b3efbe9be?w=600", "https://images.unsplash.com/photo-1580421383318-f87fc861a696?w=600"] },
  { id: "jar-2", title: "Festive & Holiday Treats", recipeCount: 2, coverImages: ["https://images.unsplash.com/photo-1499636136210-6f4ee915583e?w=600", "https://images.unsplash.com/photo-1703118834585-67fd82bdefdd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwaXhlbCUyMGFydCUyMGNvb2tpZXN8ZW58MXx8fHwxNzY0MjI5NzM4fDA&ixlib=rb-4.1.0&q=80&w=1080"] },
  { id: "jar-3", title: "Soft & Chewy Classics", recipeCount: 2, coverImages: ["https://images.unsplash.com/photo-1509365465985-25d11c17e812?w=600", "https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=600"] },
];
...
export function HomeFeed({ isLoggedIn = false, onLogout }: HomeFeedProps) {
  ...
  return (
    <div className="min-h-screen bg-[var(--background-image)] pb-12">
      <NavBar isLoggedIn={isLoggedIn} onLogout={onLogout} notificationCount={3} />
